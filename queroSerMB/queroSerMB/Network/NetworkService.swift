        ...
        fetchBinanceSymbols(for: exchangeId) { result in
            ...
            case .success(let symbols):
                ...
                for symbol in filteredSymbols {
                    ...
                    if baseAsset == "ETH" {
                        ohlcvURLString = "https://rest.coinapi.io/v1/ohlcv/BINANCE_SPOT_ETH_USDC/history?period_id=1HRS&time_start=2023-10-23T20:43:52.0870000Z&time_end=2023-10-24T20:43:52.0870000Z"
                    } else {
                        ohlcvURLString = "https://rest.coinapi.io/v1/ohlcv/BINANCE_SPOT_BTC_USDC/history?period_id=1HRS&time_start=2023-10-23T20:43:52.0020000Z&time_end=2023-10-24T20:43:52.0020000Z"
                    }
